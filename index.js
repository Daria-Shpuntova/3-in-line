let config = {
    ...
    imagesCoin : ['img/crystal-1.jpg', 'img/crystal-2.jpg' , 'img/crystal-3.jpg' , 'img/crystal-4.jpg' , 'img/crystal-5.jpg' ,
                    'img/crystal-6.jpg', 'img/crystal-7.jpg', 'img/crystal-8.jpg'],
...
// Инициализация всех состовляющих игры
function initGame() {
...
function createPage() {
    ...
    components.container.style.overflo = 'hidden';
...
function createCursor() {
    ...
    components.cursor.style.wigth = config.gemSize - 10 + 'px';
...
function createScore() {
    ...
    components.score.style.fontFamily = 'sans-sarif';
    components.score.style.fontSize = '16px';
    components.score.style.color = '#fff';
...
//Создание и наполнение сетки монетами
function createGrid() {
...
//Проверка на группу сбора по рядам
...
function handlerTab( event, target ){
    //Если это элемент с классом config.gemClass
    //и
    //Если подходящие состояние игры
...
function gemSwitch(){
    ...
    $('.switch').each(function() {
        ...
        },
        {
            duration: 250,
            complete: function() {
            //Проверяем допустимость данного хода
            checkMoving();
            }
        }
        );
